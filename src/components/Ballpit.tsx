...
const Ballpit = ({ className = "", followCursor = true, ...props }) => {
  ...
  useEffect(() => {
    ...
    // Create a fresh canvas per mount. React StrictMode (dev) double-invokes
    // effects; the cleanup forceLoses the GL context on the previous canvas,
    // which would make a reused canvas return a null context on remount.
