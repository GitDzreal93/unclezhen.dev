  ...
  return (
    <form className="admin-form" onSubmit={onSubmit}>
      ...
      <div className="field">
        ...
        <textarea id="blurb" name="blurb" defaultValue={project?.blurb} />
      </div>
      <div className="field">
      ...
      <div className="field">
        ...
        <textarea id="stack" name="stack" defaultValue={project?.stack?.join("\n")} />
      </div>
      <div className="field">
      ...
      <div className="admin-form__actions">
        ...
        <button className="btn btn--ghost" type="button" onClick={() => router.push("/admin/projects")}>
          取消
        </button>
      </div>
    </form>
